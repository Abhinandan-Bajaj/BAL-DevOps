...
/* 2024-10-18 	|	Aniket Mahulikar        | ASM_MC_SERVICE_COMPLAINT_MASTER_DIM- Updated Contacted Within 1hr , INC Script, SOurce table */     
/*----------------------------------------------------------------------------------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------------------------------------------------------------------------------*/
/*******************************************HISTORY****************************************************************************************************/
...
ALTER PROC [dbo].[USP_ASM_MC_SERVICE_DIMENSION_FULLOAD_P3] AS
BEGIN

PRINT('LOADING DATA FROM Source TABLE')
--*****************************************************************
--2. Load Spare Claim Header DIM for MC

TRUNCATE TABLE ASM_MC_SERVICE_SPARE_CLAIM_HEADER_DIM
...
TRUNCATE TABLE ASM_MC_SERVICE_COMPLAINT_MASTER_DIM; 
