...
CREATE PROC [dbo].[USP_ASM_CV_SERVICE_RETAIL_FULLLOAD] AS
BEGIN

TRUNCATE TABLE [dbo].[ASM_CV_SERVICE_RETAIL_STG]
...
TRUNCATE TABLE [dbo].[ASM_CV_FREE_SERVICE]
...
WHERE CAST(RH.DOCDATE AS DATE)>='2016-04-01'
