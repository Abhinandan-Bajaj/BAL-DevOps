...
Alter PROC [dbo].[USP_ASM_PB_T_STOCK_REFRESH] AS
BEGIN
--***************************START********************************************************************************
/*******************************************HISTORY***************************************************************/
/*---------------------------------------------------------------------------------------------------------------*/
...
set @ASMFact_IMPORTEDDATE = CAST((SELECT MAX(DATE) from ASM_PB_T_STOCK_FACT)AS DATE);


DECLARE @SPID INT = @@SPID,
        @sp_name VARCHAR(128) = 'USP_ASM_PB_T_STOCK_REFRESH';
...
DECLARE @StartDate_utc1 DATETIME = GETDATE(),
			...
			@table_name1 VARCHAR(128) = 'ASM_PB_T_STOCK_FACT', 
            @SourceCount1 BIGINT,  
            @TargetCount1 BIGINT,   
            @Status1 VARCHAR(10),
