...
CREATE PROC [dbo].[USP_ASM_SPARES_ICMC_RETAIL_SALES_FULLLOAD]
AS
BEGIN
/*******************************************HISTORY**************************************************/
/*--------------------------------------------------------------------------------------------------*/
...
TRUNCATE TABLE [dbo].[ASM_ICMC_SPARES_RETSALES_STG];
...
AND DOCDATE >= '2023-04-01'
and COMPANYCODE >= '0000015000' AND COMPANYCODE <='0000018000'
)A GROUP BY LINE_ID,COMPANYCODE, BU,CONTACTCODE, DOCDATE,Importeddate
) 
