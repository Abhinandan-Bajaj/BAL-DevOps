...
CREATE PROC [dbo].[USP_ASM_MC_SERVICE_RETAIL_FULLLOAD] AS
BEGIN

TRUNCATE TABLE [dbo].[ASM_MC_SERVICE_RETAIL_STG]
TRUNCATE TABLE [dbo].[ASM_MC_SERVICE_RETAIL_STG_FINAL]
TRUNCATE TABLE [dbo].[ASM_MC_RETAIL_FLAGS]
