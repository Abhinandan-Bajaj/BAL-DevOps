...
CREATE PROC [dbo].[USP_Full_Load_ASM_MC_DENORM_REFRESH_fourth] AS BEGIN
...
DECLARE @year INT = YEAR(GETDATE())-3 ;
...
/*
PRINT(
    'Deleted last 60 days data from ASM_MC_SALES_DENORM_MODEL table'
)
