...
CREATE PROC [dbo].[USP_ASM_PB_SERVICE_PM_PARTS_FULL_LOAD] AS 
/*******************************************HISTORY**************************************************/
/*--------------------------------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------------------------------*/
...
print('Truncating table ASM_PB_SERVICE_PM_PARTS_STG')
TRUNCATE TABLE ASM_PB_SERVICE_PM_PARTS_STG
...
print('Truncating table ASM_PB_PM_PARTS_REPORT')
TRUNCATE TABLE ASM_PB_PM_PARTS_REPORT
