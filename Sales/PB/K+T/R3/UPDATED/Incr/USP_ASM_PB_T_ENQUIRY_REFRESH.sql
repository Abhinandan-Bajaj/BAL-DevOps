...
and Try_Cast(CreatedON as DATE)>= ( select  ISNULL(DATEADD(DAY, -5, MAX(EnquiryDate)), '2023-01-01')  from ASM_PB_T_ENQUIRY_DIM)
...
DECLARE @StartDate_utc2 DATETIME = GETDATE(),
		...
		@table_name2 VARCHAR(128) = 'ASM_TRIUMPH_ENQUIRY_STG', 
        @SourceCount2 BIGINT,  
        @TargetCount2 BIGINT,   
        @Status2 VARCHAR(10),
