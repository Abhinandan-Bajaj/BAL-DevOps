/****** Object:  StoredProcedure [dbo].[USP_Full_Load_ASM_MC_RETAIL_REFRESH]    Script Date: 9/19/2024 10:17:01 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROC [dbo].[USP_Full_Load_ASM_MC_RETAIL_REFRESH] AS
BEGIN
/*******************************************HISTORY**************************************************/
/*--------------------------------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------------------------------*/
...
AND DEALER IN (SELECT DISTINCT DEALERCODE FROM ASM_MC_DEALER_MASTER_DIM)   --UPDATED ON 24-JAN 2023 AS PER BUG FIX FOR REQUEST FROM AADARSH
GROUP BY
DEALER,
SAP_ZSD_SKU_PLAN.SKU,
...
UNION
SELECT *,NULL as  First_Source_Lead_Type,Null As First_Mode_Source,Null As First_Mode_SubSource ,NULL as CityBV,NULL As DPP 
