...
CREATE PROC [dbo].[USP_ASM_PB_SERVICE_OPENJC_FULLLOAD] AS
BEGIN
...
TRUNCATE table ASM_PB_OPEN_JC_STG
Print('Truncating table ASM_PB_OPEN_JC_STG')
...
WHERE CAST(SH.DOCDATE AS DATE) BETWEEN '2018-04-01' AND '2023-11-07'
