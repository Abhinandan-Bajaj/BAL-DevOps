...
/*--------------------------------------------------------------------------------------------------*/
/*	2024-06-10 	|	Nikita L		| ZBU TYPE CHANGE IN KTM     (CHANGE BY BU IN ZBU TYPE VALUES)  */
/*	2025-05-15	|	 Ashwini		|  F model codes inclusion */
/*--------------------------------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------------------------------*/
/*******************************************HISTORY**************************************************/
--******************************* START ******************************************
...
LEFT JOIN (
    ...
    FROM CDMS_BRANCH_PRODUCT_MAPPING_VEHICLE
    GROUP BY BRANCHID
